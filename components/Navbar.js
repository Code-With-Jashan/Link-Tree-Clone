...
const Navbar = () => {
  ...
  return (
    <>
      {showNavbar && (
        <nav className="bg-white flex justify-between items-center fixed top-4 left-1/2 -translate-x-1/2 rounded-full p-3 px-7 shadow-md z-50
                        w-[90vw] [@media(min-width:1024px)_and_(max-width:1400px)]:w-[85vw] [@media(min-width:1024px)_and_(max-width:1400px)]:top-6
                        lg:w-[80vw] lg:top-6">
          
          {/* Logo */}
          <Link href="/">
            <svg className='md:h-8 h-6' viewBox="0 0 1176 238" title="Linktree Logo" xmlns="http://www.w3.org/2000/svg">
          ...
          <ul className="hidden lg:flex gap-10 font-medium">
            <Link href="/"><li className="hover:text-gray-700">Templates</li></Link>
            <Link href="/"><li className="hover:text-gray-700">Marketplace</li></Link>
            <Link href="/"><li className="hover:text-gray-700">Discover</li></Link>
            <Link href="/"><li className="hover:text-gray-700">Pricing</li></Link>
            <Link href="/"><li className="hover:text-gray-700">Learn</li></Link>
          </ul>

          {/* Desktop Login/Signup */}
          <div className="hidden lg:flex gap-3">
            <button className="login bg-[#eff0ec] font-bold px-4 py-2 rounded-lg">
              Log in
            </button>
            <button className="signup bg-gray-900 text-white font-bold px-4 py-2 rounded-full">
              Sign up free
            </button>
          </div>
          ...
          {/* Mobile/Tablet Menu */}
          {isOpen && (
            <div className="absolute top-[70px] left-0 text-center w-full bg-white rounded-b-2xl shadow-md lg:hidden">
              ...
              <div className="flex flex-col gap-3 p-6 border-t border-gray-200">
                <button className="login bg-[#eff0ec] font-bold px-4 py-2 rounded-lg">Log in</button>
                <button className="signup bg-gray-900 text-white font-bold px-4 py-2 rounded-full">Sign up free</button>
              </div>
            </div>
          )}
        </nav>
